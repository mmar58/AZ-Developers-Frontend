...
const WebAppDevelopment: React.FC = () => {
  ...
  const webAppProjects = PROJECTS.filter(project => project.category === ProjectCategory.WEB_APPS);
    ...
    <>
      ...
      <div className="min-h-screen bg-[#3f4555] py-20 px-4">
        <div className="max-w-5xl mx-auto">
          <h1 className="text-4xl font-bold text-white mb-6 text-center">Web App Development</h1>
          <p className="text-slate-300 mb-10 text-center max-w-2xl mx-auto">We deliver robust, scalable web applications tailored to your business needs. Our solutions are secure, performant, and user-friendly.</p>
